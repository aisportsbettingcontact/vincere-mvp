    ...
    >
      ...
      <div className="hidden md:flex md:flex-row md:items-stretch">
        ...
        <div className="flex-1 min-w-0">
          {/* Column Headers */}
          <div 
            className="grid grid-cols-3 gap-px px-2 md:px-4 py-1.5 md:py-2"
            style={{
              background: "var(--ma-surface)",
              borderBottom: "1px solid var(--ma-stroke)"
            }}
          ...
          {/* Odds Values */}
          <div className="px-2 md:px-4 py-2 md:py-3 space-y-1.5 md:space-y-2 relative" style={{ background: "var(--ma-card)" }}>
            {/* AT Label - Centered between rows */}
            <div className="absolute left-0 top-1/2 -translate-y-1/2 text-[10px] md:text-xs font-semibold px-2 md:px-4" style={{ color: "var(--ma-text-secondary)" }}>
              AT
            </div>
