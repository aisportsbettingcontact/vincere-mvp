/**
 * Color utility functions for hex conversion, similarity detection, and contrast selection
 */
 ...
 * Threshold of ~100-120 works well for detecting similar colors
 */
...
/**
 * Legacy alias for areColorsSimilar (for backwards compatibility)
 */
export function areColorsTooSimilar(color1: string, color2: string): boolean {
  return areColorsSimilar(color1, color2);
}
