          ...
          >
            ...
            {hasDK && (
              <button
                ...
                className="relative z-10 w-10 h-10 rounded-[10px] transition-all flex items-center justify-center"
                style={{
              ...
              >
                <img src={draftKingsLogo} alt="DraftKings" className="w-7 h-7 object-contain" />
              </button>
            )}
            {hasCirca && (
              <button
              ...
              >
                <img src={circaLogo} alt="Circa" className="w-7 h-7 object-contain" />
              </button>
            )}
          </div>
        )}
            ...
            >
              ...
              {hasDK && (
                <button
                  ...
                  className="relative z-10 w-9 h-9 rounded-[7px] transition-all flex items-center justify-center"
                  style={{
                    opacity: selectedBook === "DK" ? 1 : 0.5,
                    background: hasDK && !hasCirca ? "rgba(111, 116, 255, 0.14)" : "transparent",
                    border: hasDK && !hasCirca ? "1px solid var(--ma-accent-indigo)" : "none"
                ...
                >
                  <img src={draftKingsLogo} alt="DraftKings" className="w-6 h-6 object-contain" />
                </button>
              )}
              {hasCirca && (
                <button
                ...
                >
                  <img src={circaLogo} alt="Circa" className="w-6 h-6 object-contain" />
                </button>
              )}
            </div>
          )}
